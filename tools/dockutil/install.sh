...
app_exists kitty && "$dockutil" --add "/Applications/kitty.app" --after "com.apple.Notes" --no-restart
...
app_exists BusyCal && "$dockutil" --add "/Applications/BusyCal.app" --after "com.apple.MobileSMS"
